 ...
 */
	...
	Router::connect('/world-chat-get', array('controller' => 'Dashboard', 'action' => 'getMessage'));
	Router::connect('/world-chat-send', array('controller' => 'Dashboard', 'action' => 'sendMessage'));
	Router::connect('/world-chat', array('controller' => 'Dashboard', 'action' => 'index'));
